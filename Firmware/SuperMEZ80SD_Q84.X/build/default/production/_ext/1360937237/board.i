...
void (*board_write_sram_regions_hook)(const mem_region_t *regions, unsigned int n, int bank) = ((void*)0);
void (*board_read_from_sram_hook)(uint16_t addr, uint8_t *buf, unsigned int len) = ((void*)0);
void (*board_read_sram_regions_hook)(const mem_region_t *regions, unsigned int n, int bank) = ((void*)0);
__bit (*board_io_event_hook)(void) = ((void*)0);
void (*board_wait_io_event_hook)(void) = ((void*)0);
void (*board_clear_io_event_hook)(void) = ((void*)0);
int (*board_clock_op_hook)(int clocks) = ((void*)0);
